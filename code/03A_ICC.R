...
model3 <- readRDS("./outputs/models/03A_multivariate-model3.rds")
model4 <- readRDS("./outputs/models/03A_multivariate-model-novice.rds")
model5 <- readRDS("./outputs/models/03A_multivariate-model-experienced.rds")
