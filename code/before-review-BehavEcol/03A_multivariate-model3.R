...
#               Multivariate model of predator behaviour #3              #
#                         Control for map size
...
setnames(map_dat, "MapName", "map_name")
data <- merge(data, map_dat[,c(2,5)], by = "map_name")
...
data[, c("Zsqrtspeed", "Zsqrtspace_covered_rate", "Zsqrtprox_mid_guard",
         ...
         "Zsqrtsurv_space_covered_rate", "Zsurface_area_m2") :=
...
save(mv_model3, file = "03A_multivariate-model3.rda")
# ======================================================================
# ======================================================================