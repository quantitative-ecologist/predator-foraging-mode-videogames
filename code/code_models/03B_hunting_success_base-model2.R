...
# This model quantifies the relationship between predator behaviour 
# + prey behaviour and hunting success. 
...
saveRDS(base_model, file = "03B_hunting_success_base_model2.rds")
