...
output: 
  word_document:
    reference_docx: styles_final_document_word.docx
...
table1 <- newtab %>%
  ...
  set_header_df(mapping = my_header1,
                key = "col_keys") %>%
  my_theme %>%
  merge_v(part = "header") %>%
  merge_h(part = "header") %>%
  ...
  width(j = c(1:5),
        width = 1.6) %>%
  # control the height of specific lines
  height(height = .45,
         part = "body",
         i = c(7:18)) %>%
  # control the height of specific lines
...
# Add title
table1 <- font(
  set_caption(table1, "Table 1: Estimates of the models relating predator hunting success to predator hunting behavior, prey behavior, and their interactions."),
  fontname = "Times New Roman",
  part = "all")

# Add footnote
table1 <- font(footnote(table1, 
                        i = 1,
                        j = 1,
                        part = "header",
                        value = as_paragraph(
