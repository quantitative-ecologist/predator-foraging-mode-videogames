---
title: "Online supporting information for  \nAnalyzing individual variation in predator hunting mode and the effect of predator and prey behavior on hunting success with an online multiplayer videogame"
output: 
  pdf_document:
